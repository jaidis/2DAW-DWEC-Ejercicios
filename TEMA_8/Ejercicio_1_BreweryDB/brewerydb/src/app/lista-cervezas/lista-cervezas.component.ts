...
export class ListaCervezasComponent implements OnInit {
  ...
  constructor(private servicio: ServicioApiService) {
    ...
    this.cervezasDelMundo = [
      ...
      { nombre: 'Jupiler', id: 'mQcs4d', url: 'https://s3.amazonaws.com/brewerydbapi/beer/mQcs4d/upload_SXKW41-medium.png' },
      ...
      { nombre: 'La Trappe Dubbel', id: 'dxZqmo', url: 'https://s3.amazonaws.com/brewerydbapi/beer/dxZqmo/upload_35R3av-medium.png' },
      ...
      { nombre: 'Hoegaarden', id: 'wfsyxi', url: 'https://s3.amazonaws.com/brewerydbapi/beer/wfsyxi/upload_knliYV-medium.png' }
    ];
    this.filtro = '';
  }

  ngOnInit() {
    this.servicio.getBusqueda('Heineken');
